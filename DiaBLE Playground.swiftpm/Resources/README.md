...
The Shell in the Console allows opening both encrypted and decrypted _trident.realm_ files from a backup of the Libre 3 app data (the Container folder extracted for example by using iMazing): an Android rooted distribution like Waydroid is required to unwrap the Realm encryption key.
